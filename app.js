...
// Data is supplied by Flask from the logged-in user's expenses.
// =========================================================

const spendingChart = document.getElementById("spendingChart");
const dashboardData = window.campusPayDashboard || null;

if (spendingChart && typeof Chart !== "undefined" && dashboardData) {
    new Chart(spendingChart, {
        ...
        data: {
            ...
            datasets: [{
                label: "Spending",
                data: dashboardData.chart_values || [],
                borderColor: "#7569C9",
